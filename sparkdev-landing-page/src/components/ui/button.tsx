  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        spark:
          "relative bg-gradient-to-r from-spark-orange via-spark-pink to-spark-purple text-primary-foreground shadow-lg hover:shadow-2xl hover:scale-[1.03] active:scale-[0.98] before:absolute before:inset-0 before:rounded-lg before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:opacity-0 hover:before:opacity-100 before:transition-opacity overflow-hidden",
        sparkOutline:
          "relative border border-spark-orange/50 bg-card text-foreground shadow-md hover:shadow-lg hover:scale-[1.02] hover:border-spark-orange active:scale-[0.98]",
      },
      size: {
